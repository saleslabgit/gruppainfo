...
@section('content')
@php
    $navigation = new Illuminate\Support\HtmlString('<div class="ui-nav-label">Система</div><a class="ui-nav-item is-active" href="#foundations"><i data-lucide="palette"></i>Основа</a><a class="ui-nav-item" href="#forms"><i data-lucide="text-cursor-input"></i>Формы</a><a class="ui-nav-item" href="#data"><i data-lucide="table-2"></i>Данные</a><a class="ui-nav-item" href="#states"><i data-lucide="circle-alert"></i>Состояния</a>');
@endphp
<x-ui.app-shell :navigation="$navigation">
    ...
    <section class="ui-kit-section" id="states">
        ...
        <div class="ui-demo ui-demo--row"><x-ui.confirmation title="Опубликовать изменения?" message="Новые данные сразу увидят пользователи." /><x-ui.confirmation title="Удалить запись?" message="Это действие нельзя отменить." danger /></div>
    </section>
